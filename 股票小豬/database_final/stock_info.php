<?php
    ...
    // $mId =  isset( $_GET["mId"]) ? $_GET["mId"]:$_COOKIE{"mId"};
	// $sId = isset( $_GET["sId"]) ? $_GET["sId"]:$_COOKIE{"sId"};
	// $sName = isset( $_GET["sName"]) ? $_GET["sName"]:$_COOKIE{"sName"};
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md col-lg stock">
                        ...
                        <a href="#" class="info">                        
                            ...
                            <p class="price"><?php echo "{$stock[$i][4]}";?></p>
                        </a>
                    </div>
                    <?php
                        $i++; 
